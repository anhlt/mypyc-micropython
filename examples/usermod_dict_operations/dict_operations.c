...
static mp_obj_t dict_operations_get_with_default(mp_obj_t d_obj, mp_obj_t key_obj, mp_obj_t default_val_obj) {
    ...
    mp_obj_t _tmp1 = mp_call_function_n_kw(mp_load_attr(d, MP_QSTR_get), 2, 0, (mp_obj_t[]){key, mp_obj_new_int(default_val)});
    mp_int_t result = mp_obj_get_int(_tmp1);
...
static mp_obj_t dict_operations_merge_dicts(mp_obj_t d1_obj, mp_obj_t d2_obj) {
    ...
    mp_obj_t result = mp_obj_new_dict(0);
    mp_obj_t _tmp1 = mp_call_function_0(mp_load_attr(d1, MP_QSTR_keys));
    mp_obj_t key;
    mp_obj_iter_buf_t _tmp4;
    mp_obj_t _tmp3 = mp_getiter(_tmp1, &_tmp4);
    while ((key = mp_iternext(_tmp3)) != MP_OBJ_STOP_ITERATION) {
        mp_obj_subscr(result, key, mp_obj_subscr(d1, key, MP_OBJ_SENTINEL));
    }
    mp_obj_t _tmp2 = mp_call_function_0(mp_load_attr(d2, MP_QSTR_keys));
    mp_obj_iter_buf_t _tmp6;
    mp_obj_t _tmp5 = mp_getiter(_tmp2, &_tmp6);
...
static mp_obj_t dict_operations_copy_dict(mp_obj_t d_obj) {
    ...
    mp_obj_t _tmp1 = mp_call_function_0(mp_load_attr(d, MP_QSTR_copy));
    return _tmp1;
}
...
static mp_obj_t dict_operations_clear_dict(mp_obj_t d_obj) {
    ...
    mp_obj_t _tmp1 = mp_call_function_0(mp_load_attr(d, MP_QSTR_clear));
    (void)_tmp1;
    return d;
}
...
static mp_obj_t dict_operations_setdefault_key(mp_obj_t d_obj, mp_obj_t key_obj, mp_obj_t value_obj) {
    ...
    mp_obj_t _tmp1 = mp_call_function_n_kw(mp_load_attr(d, MP_QSTR_setdefault), 2, 0, (mp_obj_t[]){key, mp_obj_new_int(value)});
    return _tmp1;
}
...
static mp_obj_t dict_operations_pop_key(mp_obj_t d_obj, mp_obj_t key_obj) {
    ...
    mp_obj_t _tmp1 = ({ mp_obj_t __method[3]; mp_load_method(d, MP_QSTR_pop, __method); __method[2] = key; mp_call_method_n_kw(1, 0, __method); });
    return _tmp1;
}
...
static mp_obj_t dict_operations_pop_key_default(mp_obj_t d_obj, mp_obj_t key_obj, mp_obj_t default_val_obj) {
    ...
    mp_obj_t _tmp1 = ({ mp_obj_t __method[4]; mp_load_method(d, MP_QSTR_pop, __method); __method[2] = key; __method[3] = mp_obj_new_int(default_val); mp_call_method_n_kw(2, 0, __method); });
    return _tmp1;
}
...
static mp_obj_t dict_operations_popitem_last(mp_obj_t d_obj) {
    ...
    mp_obj_t _tmp1 = mp_call_function_0(mp_load_attr(d, MP_QSTR_popitem));
    return _tmp1;
}
...
static mp_obj_t dict_operations_update_dict(mp_obj_t d1_obj, mp_obj_t d2_obj) {
    ...
    mp_obj_t _tmp1 = mp_call_function_1(mp_load_attr(d1, MP_QSTR_update), d2);
    (void)_tmp1;
    return d1;
}
