...
static const point_Point3D_vtable_t point_Point3D_vtable_inst = {
    .distance_squared = (mp_int_t (*)(point_Point3D_obj_t *))point_Point_distance_squared_native,
    .add = (mp_int_t (*)(point_Point3D_obj_t *, mp_int_t, mp_int_t))point_Point_add_native,
...
static mp_obj_t point_Point3D_make_new(const mp_obj_type_t *type, size_t n_args, size_t n_kw, const mp_obj_t *args) {
    ...
    self->super.vtable = (const point_Point_vtable_t *)&point_Point3D_vtable_inst;
